...
# 源代码的gitee远程仓库 https://gitee.com/suichenTree/shuyx-admin-services.git    main分支  这个远程仓库的仓库别名是 origin ，是默认仓库
# 源代码的github远程仓库 https://github.com/suichentree/shuyx-admin-services.git  main分支  这个远程仓库的仓库别名是 github-origin ，非默认仓库
...
# ============================= 配置变量 =======================================
# 源代码 gitee 远程仓库名称和URL
REMOTE_GITEE_NAME="origin"
REMOTE_GITEE_URL="https://gitee.com/suichenTree/shuyx-admin-services.git"
# 源代码 github 远程仓库名称和URL
REMOTE_GITHUB_NAME="github-origin"
REMOTE_GITHUB_URL="https://github.com/suichentree/shuyx-admin-services.git"
